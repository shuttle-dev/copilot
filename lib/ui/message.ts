...
const MESSAGE = {
	...
	COMMAND_MENU_ENVIRONMENT_VARIABLES_QUESTION: (environmentVariables: Command['environmentVariables']) => `${chalk.dim('I can')} ${chalk.underline('change the environment variables')} ${chalk.dim(`(${environmentVariables})`)}`,
	...
	COMMAND_CREATE_ENVIRONMENT_VARIABLES_QUESTION: 'Which environment variables should I use?',
	...
	COMMAND_UPDATE_ENVIRONMENT_VARIABLES_QUESTION: 'Which environment variables should I use?',
